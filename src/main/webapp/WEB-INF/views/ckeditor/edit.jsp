...
<div  align="center">
<h2> 상세보기/수정하기   </h2>
<form method="post"  action="${path}/ckeditor/update.do" enctype="multipart/form-data">

<input type=hidden  name=idx size=40  value="${m.getIdx()}">
...
<tr><td>첨부파일</td>
<td><a href="${path}/ckeditor/files/${m.filename}" download="${m.filename }">${m.filename}</a>
</td>
</tr>
<tr> <td  align="center">내용 </td> <td> 
  <textarea cols=50 rows=6 id="editor" name=etc>${m.getEtc()}</textarea>
 </td> </tr>
